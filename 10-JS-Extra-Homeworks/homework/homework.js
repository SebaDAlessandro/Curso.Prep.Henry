...
function deObjetoAmatriz(objeto){
  // Escribe una función que convierta un objeto en una matriz (arreglo), donde cada elemento representa 
...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
  // con .split devuelve un array con por palabra ["The", "Henry", "Challenge", "is", "close!"]
